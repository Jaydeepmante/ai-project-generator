/**
 * Navbar.jsx — Updated with Pricing tooltip, improved hover states,
 * purple glow on active/hover, and consistent dark theme.
 */
...
export default function Navbar() {
    ...
    return (
        ...
        >
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link to="/" className="flex items-center gap-2 group">
                        ...
                        <span className="text-white font-bold text-lg tracking-tight">
                            JRI{" "}
                            <span className="text-violet-400 group-hover:text-violet-300 transition-colors duration-200">
                                AI
                            </span>
                        </span>
                    </Link>
                            ...
                            if (link.tooltip) {
                                return (
                                    <div key={link.label} className="relative" ref={tipRef}>
                                        ...
                                        {/* Tooltip dropdown */}
                                        {pricingTip && (
                                            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-56 px-4 py-3 rounded-xl bg-[#111120] border border-violet-500/25 shadow-2xl shadow-violet-900/40 text-xs text-white/60 leading-relaxed z-50 text-center">
            ...
            {/* ── Mobile Menu ─────────────────────────────────── */}
            {menuOpen && (
                <div className="md:hidden bg-[#0a0a0f]/97 backdrop-blur-md border-t border-white/5 px-6 pb-6 pt-3">
